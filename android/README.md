...
- `app/` — Android-приложение (Kotlin + Jetpack Compose, `minSdk 26`).
- `agent/` — агент на ПК (.NET 8, трей): метрики LibreHardwareMonitor,
  медиа-сессия Windows, макросы, git/GitHub. См. `agent/README.md`.
...
**ПК:** собрать и запустить агента (см. `agent/README.md`), от администратора.
