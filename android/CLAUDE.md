...
**Звук** (микшер: мастер-громкость, мьют, кнопка мьюта микрофона, per-app
сессии через Core Audio/NAudio на агенте, пуш раз в 2 с), **Время**
(плейтайм-трекер: агент копит время активного окна по watchlist в
playtime.json, планшет показывает сегодня/7 дней с полосками).
