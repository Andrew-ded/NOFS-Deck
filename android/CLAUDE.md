...
## Ветка feature/carve — РАЗВОРОТ ПРОДУКТА (главное, читать первым)
После «наделали фич — не складывается в продукт» решено резать до ядра и
строить вокруг ОДНОЙ идеи. Ядро, которое оставляем: **метрики ПК + макросы +
плеер**. Всё остальное (git, микшер, паспорт, сцена, QR, remote typing, игровой
режим) — в кучу «на подумать», с главного экрана убирается.
